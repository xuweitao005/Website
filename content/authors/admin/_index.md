...
<span2>[Recruitment]</span2>  I'm leading the [S2MC lab@CityU](http://s2mc.site/) and we're looking for self-motivated PhD students to join us. I have relatively broad research interests, but generally my previous research focuses on IoT such as smart sensing, IoT security, IoT+AI, wireless network etc (please visit our group website for more details). For current available PhD positions in my group. please visit [Recruitment](https://www.weitaoxu.com/recruitment/) for more information.
